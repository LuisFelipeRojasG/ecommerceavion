...
function Listings() {
  ...
  const { dataProducts, getAllProducts, isLoading } = useAvionContext();
  ...
  return (
    <section className='col-start-1 col-end-5 md:col-end-13 text-center pb-24'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8 justify-items-center p-10 lg:px-6'>
          {isLoading ? (
            // Mostrar skeletons mientras carga - 4 skeletons para mantener consistencia visual
